...
,
"""
Cost Performance Report (CPR) format """
,
"""
A report identifying the cost performance on a contract
...
remaining portion of the contract (format 3 - staffing).
"""
,
"""
...
,
"""
Customs summary declaration with commercial detail,
alternate
...
,
"""
Customs summary declaration without commercial detail,
alternate
...
Document/message by which goods are declared for import
Customs clearance according to Annex B."""
,
""" (concerning
...
Customs transit according to Annex E."""
,
""" (concerning
...
def get_description(postition):
    ...
    return description_name_code[postition]
